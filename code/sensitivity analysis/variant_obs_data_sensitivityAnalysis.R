...
# import data 
# sir_init_Cond_scenarios <- list.files(path = "./exported data/sensitivity analysis data export/SIR Initial Condition/")
# 
# for(i in sir_init_Cond_scenarios){
#   fullPath <- paste0("./exported data/sensitivity analysis data export/SIR Initial Condition/", i)
#   
#   nc_dat <- read.csv(fullPath)
...
#     loessMod_op <- loess(I ~ days_since_start, data=df)
#     smoothed_op <- predict(loessMod_op, span = 100)
...
#     
#   }
#   cond <- gsub('sir_initCond_', '', i)
#   cond2 <- gsub('.csv','', cond)
#   ## write out observational data for fitting 
#   write_xlsx(delta_obs_dat, paste0("C:\\Users\\Cindy Pang\\nc-covid-herd-immunity-model-v2\\exported data\\sensitivity analysis data export\\Delta Obs Data\\", "delta_obs_dat_",i,".xlsx"))
# }
